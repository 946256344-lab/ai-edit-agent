...
<!-- ACTIVE_TASKS_START -->
- [ ] 进行中（2026-09-17，feature/agent-led-storyboard）：细拍、一拍一镜、模型主导生成。PR1 短窗问用户已提交。PR2：配音先于拆拍，失败不生成；词级时间戳或句内插值；`requestedDurationMs` 冲突先问。见 docs/changes/2026-09-17-tts-before-phase1.md。
