...
<!-- ACTIVE_TASKS_START -->
- [ ] 进行中（2026-09-17，feature/agent-led-storyboard）：细拍、一拍一镜、模型主导生成。PR1：P3 后短窗交选片模型换片或拨一次邻词，不再让 Phase 4 拉窗整单失败。见 docs/changes/2026-09-17-storyboard-short-window-ask.md。
